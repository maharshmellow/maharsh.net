...
description: "Learn how to create an Alfred Workflow using Python. In this tutorial, we will learn to create a workflow that can search for songs on Apple Music." 
--- 
